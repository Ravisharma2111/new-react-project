  ...
  return (
    <div>
      ...
      <div className="wrapper">
        <div
          id="subscribe-me"
          className="modal animated fade in"
          role="dialog"
          data-keyboard="true"
          tabIndex={-1}
        >
              ...
              <form method="post">
                <div className="form-group required">
                  ...
                  <label className="checkme">
                    <input type="checkbox" defaultValue id="checkme" />
                    Dont show again
                  </label>
                </div>
              </form>
              ...
              <div className="row">
                  ...
                  <ul className="header-top-left">
                    <li className="language dropdown">
                      ...
                      >
                        <li>
                          <a href="#">
                            <img src="images/English-icon.gif" alt="img" />{" "}
                            English
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="images/French-icon.gif" alt="img" />{" "}
                            French
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <img src="images/German-icon.gif" alt="img" />{" "}
                            German
                          </a>
                        </li>
                      </ul>
                ...
                <div className="col-sm-6">
                  <ul className="header-top-right text-right">
                    ...
                    <li className="cart">
                      <NavLink to="/cartPage">My Cart</NavLink>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="container">
              <nav className="navbar">
                <div className="navbar-header mtb_20">
                  {" "}
                  <NavLink className="navbar-brand" to="/index2">
                    {" "}
                ...
                <div className="header-right pull-right mtb_50">
                  ...
                  <div className="main-search pull-right">
                    <div className="search-overlay">
                      {/* Close Icon */}
                      <a href="#" className="search-overlay-close" />
                      {/* End Close Icon */}
                      <div className="container">
                        {/* Search Form */}
                        <form
                ...
                <div className="collapse navbar-collapse js-navbar-collapse pull-right">
                  <ul id="menu" className="nav navbar-nav">
                    ...
                    <li>
                      {" "}
                      <NavLink to="/categoryPage">Shop</NavLink>
                    </li>
                    <li>
                      {" "}
                    ...
                    <li className="dropdown">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li>
                          {" "}
                          <NavLink to="/singleBlog">Single Post</NavLink>
                        </li>
                      </ul>
                    </li>
                    <li>
                ...
                <div className="col-sm-8 col-md-8 col-lg-9">
                  <div className="header-bottom-right offers">
                    <div className="marquee">
                      ...
                      <span>
                        <i className="fa fa-circle" aria-hidden="true" />
                        Our 5 Tips for a Healthy Summer
                      </span>
                      <span>
                        <i className="fa fa-circle" aria-hidden="true" />
                        Sugar health at risk?
                      </span>
                      <span>
                        <i className="fa fa-circle" aria-hidden="true" />
                        The Olay Ranges - What do they do?
                      </span>
                      <span>
                        <i className="fa fa-circle" aria-hidden="true" />
                        Body fat - what is it and why do we need it?
                      </span>
                      <span>
                        <i className="fa fa-circle" aria-hidden="true" />
        ...
        <div className="container">
          <div className="row ">
              ...
              <div className="Testimonial left-sidebar-widget mb_50">
                ...
                <div className="client owl-carousel text-center pt_10">
                  <div className="item client-detail">
                    ...
                    <div className="client-designation mb_10">
                      php Developer
                    </div>
                    <p>
                      <i className="fa fa-quote-left" aria-hidden="true" />
                      Lorem ipsum dolor sit amet, volumus oporteat his at sea in
                      Rem ipsum dolor sit amet, sea in odio ..
                    </p>
                  </div>
                  <div className="item client-detail">
                    <div className="client-avatar">
            ...
            <div
              id="column-right"
              className="col-sm-8 col-md-8 col-lg-9 mtb_30"
            >
              {/* =====  BANNER STRAT  ===== */}
                    ...
                    <div className="item">
                      <div className="box-holder">
                        ...
                        <div className="post-info mtb_20 ">
                          ...
                          <p>
                            Aliquam egestas pellentesque est. Etiam a orci Nulla
                            id enim feugiat ligula ullamcorper scelerisque.
                            Morbi eu luctus nisl.
                          </p>
            ...
            <div className="row">
                ...
                <div className="content_footercms_right">
                  <div className="footer-contact">
                    <div className="footer-logo mb_40">
                      {" "}
                      {/* <NavLink to="/product">Specials</NavLink> */}
                      <NavLink to="/index2">
                        {" "}
                        <img
              ...
              <div className="col-md-3">
                ...
                <p className="mt_10 mb_20">
                  For get offers from our favorite brands &amp; get 20% off for
                  next{" "}
                </p>
              ...
              <div className="row">
                <div className="col-sm-6">
                  <div className="copyright-part">
                    @ 2017 All Rights Reserved HealthCare
                  </div>
                </div>
                <div className="col-sm-6">
